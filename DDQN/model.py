...
class DQN(object):  # 首先创建一个模型类
    ...
    def learn(self):
        ...
        # double DDQN 实质上就是 未来状态放入 现实神经网络 获取最大值的index, 在预测的行为中对应，就是不选择最大的，选择对应的，这样可以防止过估计。这样的操作有点Sarsa-lambda的味道。
